...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='data/examples/2way-single-intersection/single-intersection-vhvh.rou.xml', help="Route definition xml file.\n")
    ...
    env = SumoEnvironment(net_file='data/examples/2way-single-intersection/single-intersection.net.xml',
