...
if __name__ == '__main__':
    ...
    prs.add_argument("-route", dest="route", type=str, default='data/examples/single-intersection/single-intersection.rou.xml', help="Route definition xml file.\n")
    ...
    env = SumoEnvironment(net_file='data/examples/single-intersection/single-intersection.net.xml',
